...
Use `layout="vertical"` to stack plans vertically.
  ...
  <PlanGroupContent layout="vertical">
    <PlanCard>
      <PlanCardHeader>
        ...
        <PlanCardDescription>Everything you need to get started</PlanCardDescription>
      </PlanCardHeader>
      <PlanPrice monthlyAmount={9} yearlyAmount={90} />
      <PlanCardFeatures>
        <PlanCardFeature included>5 projects</PlanCardFeature>
        <PlanCardFeature included>Basic analytics</PlanCardFeature>
      </PlanCardFeatures>
      <PlanCardAction variant="outline">Select Plan</PlanCardAction>
    </PlanCard>
    <PlanCard variant="highlighted">
      <PlanCardHeader>
        <div className="flex items-center justify-between">
          <PlanCardTitle>Professional</PlanCardTitle>
          <PlanCardBadge>Recommended</PlanCardBadge>
        </div>
        <PlanCardDescription>Best for growing businesses</PlanCardDescription>
      </PlanCardHeader>
      <PlanPrice monthlyAmount={29} yearlyAmount={290} originalMonthlyAmount={39} originalYearlyAmount={390} />
      <PlanCardFeatures>
        <PlanCardFeature included>Unlimited projects</PlanCardFeature>
        <PlanCardFeature included>Advanced analytics</PlanCardFeature>
        <PlanCardFeature included>Priority support</PlanCardFeature>
      </PlanCardFeatures>
      <PlanCardAction>Select Plan</PlanCardAction>
    </PlanCard>
  </PlanGroupContent>
</PlanGroup>`}>
  <PlanGroup>
