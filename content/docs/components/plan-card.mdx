...
<ComponentPreview component="plan-card" example="default">
  <PlanCard>
    <PlanCardHeader>
...
<ComponentPreview component="plan-card" example="highlighted">
  <PlanCard variant="highlighted">
    <PlanCardHeader>
      <PlanCardBadge>Most Popular</PlanCardBadge>
      <PlanCardTitle>Pro</PlanCardTitle>
...
<ComponentPreview component="plan-card" example="discount">
  <PlanCard variant="highlighted">
    <PlanCardHeader>
...
<ComponentPreview component="plan-card" example="yearly">
  <PlanCard variant="highlighted">
    <PlanCardHeader>
...
<ComponentPreview component="plan-card" example="once">
  <PlanCard>
    <PlanCardHeader>
...
<ComponentPreview component="plan-card" example="compact">
...
<ComponentPreview component="plan-card" example="large">
