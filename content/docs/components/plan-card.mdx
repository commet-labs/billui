...
<ComponentPreview component="plan-card" example="preview" code={`<PlanCard variant="highlighted">
  <PlanCardHeader>
...
<ComponentPreview component="plan-card" example="default" code={`<PlanCard>
  <PlanCardHeader>
...
<ComponentPreview component="plan-card" example="highlighted" code={`<PlanCard variant="highlighted">
  <PlanCardHeader>
    <PlanCardBadge>Most Popular</PlanCardBadge>
    <PlanCardTitle>Pro</PlanCardTitle>
    <PlanCardDescription>For growing teams</PlanCardDescription>
...
<ComponentPreview component="plan-card" example="discount" code={`<PlanCard variant="highlighted">
  <PlanCardHeader>
...
<ComponentPreview component="plan-card" example="yearly" code={`<PlanCard variant="highlighted">
  <PlanCardHeader>
...
<ComponentPreview component="plan-card" example="once" code={`<PlanCard>
  <PlanCardHeader>
...
<ComponentPreview component="plan-card" example="compact" code={`<PlanCard variant="compact">
  <PlanCardHeader>
...
<ComponentPreview component="plan-card" example="large" code={`<PlanCard size="lg" variant="highlighted">
  <PlanCardHeader>
