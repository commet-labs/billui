...
<ComponentPreview registryUrl="https://billui.com/r/plan-card/demo" code={`<PlanCard>
  <PlanCardHeader>
...
<ComponentPreview code={`<PlanCard>
  <PlanCardHeader>
...
<ComponentPreview code={`<PlanCard variant="compact">
  <PlanCardHeader>
...
<ComponentPreview code={`<PlanCard size="lg" variant="highlighted">
  <PlanCardHeader>
