...
<ComponentPreview component="invoice-card" example="preview">
...
<ComponentPreview component="invoice-card" example="pending">
...
<ComponentPreview component="invoice-card" example="failed">
  <div className="w-full max-w-lg">
    <InvoiceCard>
      <InvoiceCardIcon />
      <InvoiceCardContent>
...
<ComponentPreview component="invoice-card" example="refunded">
  <div className="w-full max-w-lg">
    <InvoiceCard>
      <InvoiceCardIcon />
      <InvoiceCardContent>
...
<ComponentPreview component="invoice-card" example="draft">
  <div className="w-full max-w-lg">
    <InvoiceCard>
      <InvoiceCardIcon />
      <InvoiceCardContent>
...
<ComponentPreview component="invoice-card" example="compact">
  <div className="w-full max-w-lg">
...
<ComponentPreview component="invoice-card" example="long-date">
  <div className="w-full max-w-lg">
    <InvoiceCard>
      <InvoiceCardIcon />
      <InvoiceCardContent>
...
<ComponentPreview component="invoice-card" example="actions">
  <div className="w-full max-w-lg">
    <InvoiceCard>
      <InvoiceCardIcon />
      <InvoiceCardContent>
...
<ComponentPreview component="invoice-card" example="currency">
  <div className="w-full max-w-lg">
    <InvoiceCard>
      <InvoiceCardIcon />
      <InvoiceCardContent>
